var text = "TypeScrtipt is a front-end language that is an alternative to JavaSCript. This improves the JavaScript productivity. the typescript helps to use OOPs pattern for front-end development.";
// #1
console.log('#1');
var res = "";
...
console.log(res);
// #2 
var aOccurences = text.trim().split('').filter(function (x, y) { return x == 'a'; }).length;
console.log("#2 No. of occurences of Character \"a\" --> " + aOccurences);
var isOccurences = text.trim().split(' ').filter(function (x, y) { return x === 'is'; }).length;
